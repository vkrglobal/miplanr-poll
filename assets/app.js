...
function initCreate(){
  ...
  $('translateBtn').onclick=()=>{alert('Default language is English. In-app translation can be connected with OPENAI_API_KEY or LIBRETRANSLATE_URL. Browser translation remains free.')};
