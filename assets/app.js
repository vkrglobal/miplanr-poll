...
function updateStandardWhenRow(){
  ...
  if(s && !isNaN(s)){ $('standardDateBtn').textContent=formatLongDayDate(s); $('standardStartBtn').textContent=formatTime12Compact(s); }
  if(e && !isNaN(e)) $('standardEndBtn').textContent=formatTime12Compact(e);
}
